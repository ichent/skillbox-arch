...
graph TD
    ...
    subgraph K8s_Cluster [Kubernetes Cluster]
        ...
        subgraph Service_Identity
            IdSvc[Identity Service <br/> Go]:::service
        ...
        subgraph Service_Inventory
            InvSvc[Inventory Service <br/> Java/Spring]:::service
            InvDB[(Inventory DB <br/> PostgreSQL)]:::db
            InvSvc --> InvDB
        end

        subgraph Service_Gamification
            GameSvc[Gamification Service <br/> Java/Spring]:::service
            GameCache[(Leaderboards <br/> Redis)]:::db
            GameSvc --> GameCache
        end

        subgraph Service_Social
            SocSvc[Social Service <br/> Node.js]:::service
